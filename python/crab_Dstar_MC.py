...
config.General.requestName = 'Ds_MC_Run2018A'
config.General.workArea = 'crab_projects' #folder - diferents projects may be put in the same work area
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '/afs/cern.ch/work/r/ragomesd/B_parking/CMSSW_10_2_7/src/BanalysisMiniAOD-1/BAnalyzer/python/dstard0_cfg_MC.py' #config file used
